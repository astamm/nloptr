...
On Windows, latest version 2.7.1 of [NLopt](https://nlopt.readthedocs.io/en/latest/) from [rwinlib](https://github.com/rwinlib/nlopt) is used. So there is nothing else to be done.
