...
On Windows, for old versions of R, the *nlopt* `v2.7.1` from [rwinlib](https://github.com/rwinlib/nlopt) is used. For newer versions of R, the *nlopt* version from the corresponding `RTools` toolchain is used.
